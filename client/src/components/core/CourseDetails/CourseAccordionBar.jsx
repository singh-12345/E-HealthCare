...
const CourseAccordionBar = ({course, isActive , handleActive}) => {
  ...
  return (
    <div className='overflow-hidden border border-solid border-richblack-600 bg-richblack-700 text-richblack-5 last:mb-0'>
        <div>
            <div
            className='flex cursor-pointer items-start justify-between bg-opacity-20
            px-7 py-6 transition-[0.3s]' onClick={()=>{handleActive(course._id)}}>
        ...
        duration-[0.35s] ease-[ease]' style={{height:sectionHeight}}>
