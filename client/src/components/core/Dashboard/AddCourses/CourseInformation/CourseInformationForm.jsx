...
import { editCourseDetails , addCourseDetails , fetchCourseCategories } from "../../../../../services/operations/courseDeatils";
    ...
    <form  onSubmit = {handleSubmit(onSubmit)} className=" space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="relative">
          ...
          <HiOutlineCurrencyRupee
            className=" absolute left-3 top-1/2 inline-block -translate-y-1/2 
      ...
      <div className=" flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor=" courseBenefits">
          Benefits of the coure <sup className="text-pink-200">*</sup>
      ...
      <div className="flex justify-end gap-x-2">
        {editCourse && (
          ...
          className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-richblack-300 
            py-[8px] px-[20px] font-semibold text-richblack-800`}>Continue without Saving</button>
        )}
        <IconBtn disabled={loading}
        text={!editCourse ? "Next" : "Save changes"}><MdNavigateNext/></IconBtn>
      </div>
